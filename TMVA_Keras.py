...
factory = TMVA.Factory('TMVAClassification', output,
                       '!V:!Silent:Color:DrawProgressBar:Transformations=N,P,G:AnalysisType=Classification')
...
model.compile(loss='binary_crossentropy', optimizer=SGD(lr=0.1, decay=1e-4, momentum=0.3), metrics=['accuracy', 'precision'])
...
factory.BookMethod(dataloader, TMVA.Types.kBDT, "BDT",
                   "H:!V:VarTransform=N,P,G:"
                   "MinNodeSize=1:"
                   "NTrees=300:"
                   "MaxDepth=1:"
                   "BoostType=AdaBoost:AdaBoostBeta=1:"
